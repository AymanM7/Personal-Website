  ...
  return (
    <>
      ...
      <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
        ...
        <Skill name="Agile/Scrum" x="20vw" y="6vw" />
        <Skill name="Java" x="0vw" y="12vw" />
        <Skill name="PyTorch" x="15vw" y="-12vw" />
        <Skill name="SQL" x="32vw" y="-5vw" />
        <Skill name="Data Analytics" x="0vw" y="-20vw" />
        <Skill name="Tableau" x="18vw" y="18vw" />
        <Skill name="Research" x="-35vw" y="-5vw" />
        <Skill name="VR/AR" x="28vw" y="12vw" />
        <Skill name="IT Troubleshooting" x="-20vw" y="-15vw" />
      </div>
    </>
  )
}
